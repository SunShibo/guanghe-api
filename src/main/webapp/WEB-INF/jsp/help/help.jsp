  ...
  <div style="width: 1200px;margin: auto;">
    ...
    <div class="item_wp">
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">（2）输入手机号码、图文验证码和手机验证码，设置并确认登录密码，填写推荐理财师工号（也可不填），阅读并勾选“我已经阅读并同意《网络服务协议》《合格投资者承诺》”，点击【注册】；</p>
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">登录广和投资线上金融服务平台 — — 广和投资官网（www.xxxxxxx.com）、广和微信公众账号，以上任何平台注册成功即可成为和悦会员。</p>
        ...
        <p class="c_p_t2">说明：个人会员可通过广和投资官网、广和微信公众号完成认证过程；机构会员由广和投资理财师协助完成。</p>
        ...
        <p class="c_p_t2">会员以及贵宾可致电广和全国统一客服及预订电话400-000-0371查询消费与明细。</p>
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t1">3．如何修改交易密码</p>
        <p class="c_p_t2">点击【我的账户-账户管理】，在网站交易密码处，点击【修改】，输入当前网站交易密码，设置新网站交易密码。</p>
        <p class="c_p_t1">4．如何找回交易密码？</p>
        <p class="c_p_t2">尊敬的用户您好：若您输入错误导致密码锁定，请等待2小时候后自动解锁，或者您暂时忘记密码，均可采用以下方式找回密码：</p>
        <p class="c_p_t2">A．自助找回</p>
        <p class="c_p_t2">点击“我的账户-账户管理”，在“网站交易密码”处，点击“找回”；进入“验证身份”页面，选择开户银行名称，输入银行卡卡号、银行预留手机号、图文验证码、短信验证码，点击“确定”；进入“密码重置”页面，重置网上交易登录密码，点击“确定”，完成密码重置。</p>
        <p class="c_p_t2">B．柜台重置</p>
        <p class="c_p_t2">请您联系理财师准备如下材料：</p>
        <p class="c_p_t2">（1）开放式基金销售业务账户类申请表（密码重置）。</p>
        <p class="c_p_t2">（2）按照该表格提示填写基本信息，勾选交易密码重置。注：表格需用户本人手动填写，机打无效。</p>
        <p class="c_p_t2">（3）将您有效身份证正面以及反面，复印在一张A4纸上，并在空白处签署姓名，注：复印的身份证件请与原件保持大小一致，请勿缩放。</p>
        <p class="c_p_t2">（4）您可将以上资料扫描后发与工作人员邮箱：xxxxxxxx@xxx.com；联系电话：xxx。</p>
        <p class="c_p_t2">（5）业务办理时间：交易日9:30 - 15:00。</p>
      </div>
      <div class="item dis_none">
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">客服电话：400-000-0371</p>
        <p class="c_p_t2">客服邮箱：kf@guanghetouzi.com</p>
