  ...
  <div style="width: 1200px;margin: auto;">
    ...
    <div class="item_wp">
      <div class="item ">
        ...
        <p class="c_p_t1">7. 如何查询积分</p>
        <p class="c_p_t2">登录后点击页面右上角【我的账户】-左下方【我的积分】，可查询我的积分以及积分明细。 </p>
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">详情可咨询您的理财顾问或者官方客服：400-000-0371。</p>
      </div>
      <div class="item dis_none">
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">和悦商城旨在为您提供积分换礼服务，所有订单暂时无法退换，请您谅解。如果您兑换的商品出现包装破损、质量等问题您可致电广和投资官方客服：400-xxxx-xxx。我们将第一时间为您处理。</p>
      </div>
      <div class="item dis_none">
        <p class="c_p_title">退换服务</p>
        <p class="c_p_t1">换货说明</p>
        <p class="c_p_t2">和悦商城旨在为您提供积分换礼服务，所有订单无法退换，请您谅解。如果您兑换的商品出现包装破损、质量等问题您可在收到货品的7个工作日内致电广和投资官方客服：400-000-0371。我们将第一时间为您处理，逾期将不予处理。</p>
      </div>
      <div class="item dis_none">
      ...
      <div class="item dis_none">
        ...
        <p class="c_p_t2">      您好，如果遇到电子产品的售后维修问题，请您第一时间联系广和投资客服400-000-0371或携带电子产品到官方指定维修店维修。</p>
