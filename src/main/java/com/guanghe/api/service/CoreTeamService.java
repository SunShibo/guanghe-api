...
public class CoreTeamService {
    ...
    public String queryCoreTeam(Integer id){
        CoreTeam coreTeam=coreTeamDao.queryCoreTeam(id);
    ...
    public  String updateCoreTeam (CoreTeam coreTeam){
        if(coreTeam == null){
        ...
        if(coreTeam.getId()== null || StringUtils.isEmpty(coreTeam.getTitle())
                || StringUtils.isEmpty(coreTeam.getCore_team())){
            return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("0", "参数有误")) ;
        }
        CoreTeam coreTeam1  = coreTeamDao.queryCoreTeam(coreTeam.getId());
        if(coreTeam1 == null){
            return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("0", "数据不存在")) ;
        }
        coreTeamDao.updateCoreTeam(coreTeam);
        return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("1", "修改信息成功")) ;
    }
    public  String deleteCoreTeam(Integer id){
        ...
        return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("1", "删除信息成功")) ;
    }
    public  String addCoreTeam(CoreTeam coreTeam){
        if(coreTeam == null){
            return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("0", "参数有误")) ;
        }
        if(StringUtils.isEmpty(coreTeam.getTitle()) || StringUtils.isEmpty(coreTeam.getCore_team())){
            return JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.failure("0", "参数有误")) ;
        }
        // 添加数据
