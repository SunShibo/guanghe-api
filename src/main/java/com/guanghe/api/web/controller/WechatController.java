...
public class WechatController {
    ...
    public void oauth2(HttpServletRequest request,HttpServletResponse response){
        String REDIRECT_URI = "http%3A%2F%2Fq7suxr.natappfree.cc%2Fwechat%2FsingIn";
        String url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+ APPID +"&redirect_uri=" +REDIRECT_URI + "&response_type=code&scope=snsapi_userinfo&state=117#wechat_redirect";
